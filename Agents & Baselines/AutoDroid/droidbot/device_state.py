...
class DeviceState(object):
    ...
    def __init__(self, device, views, foreground_activity, activity_stack, background_services,
        ...
        self.backdoor_mode = self.__detect_backdoor_mode()
    ...
    def _save_important_view_ids(self):
        if os.getenv("AUTODROID_SAVE_STATE_VIEW_IDS", "").lower() not in ["1", "true", "yes", "y", "on"]:
            return
    ...
    def __detect_backdoor_mode(self):
