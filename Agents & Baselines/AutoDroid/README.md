...
1.  Prepare:
    ...
    + Prepare an OpenAI-compatible API configuration. AutoDroid now supports environment variables:
      `APIKey` / `OPENAI_API_KEY`, optional `OPENAI_BASE_URL`, and optional `OPENAI_MODEL_NAME`.
