...
def _build_openai_client():
    ...
    if not api_key:
        raise RuntimeError(
            "Missing API key. Set one of: APIKey, OPENAI_API_KEY, THIRD_PARTY_API_KEY, GPT4O_API_KEY"
        )
...
def _get_model_name():
    ...
    # Match the AppAgent-style environment the user is already using.
