...
First, you need some keys to operate the MobileGPT Server. MobileGPT also supports OpenAI-compatible third-party APIs.
...
For an OpenAI-compatible third-party service, you can also set:

```
APIKey = "<Your Third-Party Key>"
OPENAI_BASE_URL = "https://your-provider/v1"
OPENAI_MODEL_NAME = "your-model-name"
OPENAI_EMBEDDING_MODEL = "your-embedding-model"
```

If your embedding service uses a different endpoint or key, you can also set
`OPENAI_EMBEDDING_BASE_URL` and `OPENAI_EMBEDDING_API_KEY`.
