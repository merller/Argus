...
interface NativeInputManagerService {
    ...
    int verifyArgusSubjectTag(int source, int eventId, long counter, long mac, int purpose,
            int callerPid, int callerUid);

    long[] mintArgusAgentTag(int source, int eventId, int callerPid, int callerUid);
    ...
    class NativeImpl implements NativeInputManagerService {
        ...
        @Override
        public native int verifyArgusSubjectTag(int source, int eventId, long counter, long mac,
                int purpose, int callerPid, int callerUid);

        @Override
        public native long[] mintArgusAgentTag(int source, int eventId, int callerPid,
                int callerUid);
