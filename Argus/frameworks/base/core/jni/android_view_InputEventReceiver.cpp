...
static struct {
    ...
    jmethodID dispatchInputEventWithPolicyFlags;
    ...
    for (;;) {
        ...
        if (!skipCallbacks) {
            ...
            if (inputEventObj) {
                ...
                env->CallVoidMethod(receiverObj.get(),
                        gInputEventReceiverClassInfo.dispatchInputEventWithPolicyFlags,
                        seq, inputEventObj, static_cast<jint>(inputEvent->getPolicyFlags()));
                if (env->ExceptionCheck()) {
...
int register_android_view_InputEventReceiver(JNIEnv* env) {
    ...
    gInputEventReceiverClassInfo.dispatchInputEventWithPolicyFlags = GetMethodIDOrDie(env,
