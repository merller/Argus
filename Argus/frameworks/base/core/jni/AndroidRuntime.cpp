 ...
 * namespace android.
 */
//extern int register_android_view_View(JNIEnv* env);
...
extern int register_android_view_AccessibilityClickMarker(JNIEnv* env);
extern int register_android_view_ArgusDci(JNIEnv* env);
...
static const RegJNIRec gRegJNI[] = {
        ...
        //REG_JNI(register_android_view_View),
        ...
        REG_JNI(register_android_view_AccessibilityClickMarker),
        REG_JNI(register_android_view_ArgusDci),
