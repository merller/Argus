...
public abstract class AbsSeekBar extends ProgressBar {
    ...
    private void trackTouchEvent(MotionEvent event) {
        ...
        final int newProgress = Math.round(progress);
        ArgusDci.log(this, this, "onTouchEvent", "(Landroid/view/MotionEvent;)Z",
                "range_set", "pre_effect", event.getId(), ArgusDci.currentInputSource(),
                "oldProgress=" + getProgress() + ";newProgress=" + newProgress
                        + ";motionAction=" + event.getActionMasked());
        setHotspot(x, y);
        setProgressInternal(newProgress, true, false);
    }
        ...
        if (isEnabled()) {
            ...
            switch (keyCode) {
                ...
                case KeyEvent.KEYCODE_EQUALS:
                    ...
                    ArgusDci.log(this, this, "onKeyDown", "(ILandroid/view/KeyEvent;)Z",
                            "range_set", "pre_effect", event.getId(),
                            ArgusDci.currentInputSource(),
                            "oldProgress=" + getProgress() + ";newProgress="
                                    + (getProgress() + increment) + ";keyCode=" + keyCode);
