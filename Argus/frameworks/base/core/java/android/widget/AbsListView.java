...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    public boolean performItemClick(View view, int position, long id) {
        final Object callback = mOnItemClickListener != null ? mOnItemClickListener : this;
        if (!ArgusDci.log(view != null ? view : this, callback,
                mOnItemClickListener != null ? "onItemClick" : "performItemClick",
                mOnItemClickListener != null
                        ? "(Landroid/widget/AdapterView;Landroid/view/View;IJ)V"
                        : "(Landroid/view/View;IJ)Z",
                "item_click", "pre_effect", ArgusDci.currentInputEventId(),
                ArgusDci.currentInputSource(),
                "parentId=" + getId() + ";position=" + position + ";itemId=" + id
    ...
    void keyPressed() {
        ...
        if (selector != null && (isFocused() || touchModeDrawsInPressedState())
            ...
            if (longClickable && !mDataChanged) {
                ...
                mPendingCheckForKeyLongPress.rememberArgusInputContext();
    ...
    private class WindowRunnnable {
        ...
        private int mArgusInputSource;
        private int mArgusInputEventId = -1;
        ...
        public void rememberArgusInputContext() {
            mArgusInputSource = ArgusDci.currentInputSource();
            mArgusInputEventId = ArgusDci.currentInputEventId();
        }

        public void copyArgusInputContextFrom(WindowRunnnable other) {
            mArgusInputSource = other.mArgusInputSource;
            mArgusInputEventId = other.mArgusInputEventId;
        }

        public long pushArgusInputContext() {
            return ArgusDci.pushInputContextForAsync(mArgusInputSource, mArgusInputEventId);
        }
    }
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        @Override
        public void run() {
            final long previousInputContext = pushArgusInputContext();
            try {
                ...
                ArgusDci.popInputContextForAsync(previousInputContext);
            }
        }
    }
                    ...
                    if (sameWindow() && !mDataChanged) {
                        if (mX != INVALID_COORD && mY != INVALID_COORD) {
                            handled = performLongPress(
                                    child, longPressPosition, longPressId, mX, mY);
                        } else {
    ...
    boolean performLongPress(final View child,
        ...
        final Object callback = mOnItemLongClickListener != null
                ? mOnItemLongClickListener : this;
        ArgusDci.log(child != null ? child : this, callback,
                mOnItemLongClickListener != null ? "onItemLongClick" : "performLongPress",
                mOnItemLongClickListener != null
                        ? "(Landroid/widget/AdapterView;Landroid/view/View;IJ)Z"
                        : "(Landroid/view/View;IJFF)Z",
                "long_click", "pre_effect", ArgusDci.currentInputEventId(),
                ArgusDci.currentInputSource(),
                "adapterItem=true;position=" + longPressPosition + ";itemId=" + longPressId
                        + ";choiceMode=" + mChoiceMode);
    ...
    private final class CheckForTap extends WindowRunnnable implements Runnable {
        float x;
        float y;
                ...
                if (child != null && !child.hasExplicitFocusable()) {
                    ...
                    if (!mDataChanged) {
                        ...
                        if (longClickable) {
                            ...
                            mPendingCheckForLongPress.copyArgusInputContextFrom(this);
        ...
        if (mTouchMode == TOUCH_MODE_OVERFLING) {
            ...
            if (!mDataChanged) {
                if (mTouchMode == TOUCH_MODE_FLING) {
                    ...
                    mPendingCheckForTap.rememberArgusInputContext();
            ...
            case TOUCH_MODE_DONE_WAITING:
                ...
                if (child != null) {
                    ...
                    if (inList && !child.hasExplicitFocusable()) {
                        ...
                        performClick.rememberArgusInputContext();
