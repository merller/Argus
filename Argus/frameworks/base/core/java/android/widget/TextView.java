...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public void onEditorAction(int actionCode) {
        ...
        if (ict != null) {
            if (ict.onEditorActionListener != null) {
                logArgusEditorAction(ict.onEditorActionListener, actionCode, null,
                        ArgusDci.INPUT_SOURCE_IME, -1);
    ...
    private void logArgusEditorAction(OnEditorActionListener listener, int actionCode,
            @Nullable KeyEvent event, int inputSource, int inputEventId) {
        ArgusDci.log(this, listener, "onEditorAction",
                "(Landroid/widget/TextView;ILandroid/view/KeyEvent;)Z", "editor_action",
                "pre_effect", inputEventId, inputSource,
                "actionCode=" + actionCode + ";keyAction="
                        + (event != null ? event.getAction() : -1));
    }
    ...
    private int doKeyDown(int keyCode, KeyEvent event, KeyEvent otherEvent) {
                ...
                if (event.hasNoModifiers()) {
                    ...
                    if (mEditor != null && mEditor.mInputContentType != null) {
                        ...
                        if (mEditor.mInputContentType.onEditorActionListener != null) {
                            final OnEditorActionListener listener =
                                    mEditor.mInputContentType.onEditorActionListener;
                            logArgusEditorAction(listener, getActionIdForEnterEvent(), event,
                                    ArgusDci.currentInputSource(),
                                    ArgusDci.currentInputEventId());
                            if (listener.onEditorAction(this, getActionIdForEnterEvent(), event)) {
        ...
        if (mEditor != null && mEditor.mKeyListener != null) {
            ...
            if (doDown) {
                ...
                if (unicodeChar != 0 || keyCode == KeyEvent.KEYCODE_DEL
                        || keyCode == KeyEvent.KEYCODE_FORWARD_DEL
                        || keyCode == KeyEvent.KEYCODE_ENTER) {
                    ArgusDci.log(this, mEditor.mKeyListener, "onKeyDown",
                            "(Landroid/view/View;Landroid/text/Editable;ILandroid/view/KeyEvent;)Z",
                            "text_edit", "pre_effect", ArgusDci.currentInputEventId(),
                            ArgusDci.currentInputSource(),
                            "keyCode=" + keyCode + ";unicode=" + unicodeChar
                                    + ";oldLength=" + (mText != null ? mText.length() : 0));
                }
                beginBatchEdit();
                ...
                if (event.hasNoModifiers()) {
                    if (mEditor != null && mEditor.mInputContentType != null
                        ...
                        final OnEditorActionListener listener =
                                mEditor.mInputContentType.onEditorActionListener;
                        logArgusEditorAction(listener, getActionIdForEnterEvent(), event,
                                ArgusDci.currentInputSource(), ArgusDci.currentInputEventId());
                        if (listener.onEditorAction(this, getActionIdForEnterEvent(), event)) {
                            return true;
                        }
                    }
    ...
    public boolean performAccessibilityActionInternal(int action, Bundle arguments) {
        ...
        switch (action) {
            ...
            case AccessibilityNodeInfo.ACTION_SET_TEXT: {
                ...
                ArgusDci.log(this, this, "setText", "(Ljava/lang/CharSequence;)V",
                        "text_edit", "pre_effect", -1, ArgusDci.INPUT_SOURCE_ACCESSIBILITY,
                        "a11ySetText=true;newLength=" + (text != null ? text.length() : 0)
                                + ";oldLength=" + (mText != null ? mText.length() : 0));
                setText(text);
                if (mText != null) {
