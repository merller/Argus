...
public abstract class CompoundButton extends Button implements Checkable {
    ...
    public void setChecked(boolean checked) {
        if (mChecked != checked) {
            final Object callback = mOnCheckedChangeListener != null
                    ? mOnCheckedChangeListener : this;
            ArgusDci.log(this, callback,
                    mOnCheckedChangeListener != null ? "onCheckedChanged" : "setChecked",
                    mOnCheckedChangeListener != null
                            ? "(Landroid/widget/CompoundButton;Z)V" : "(Z)V",
                    "checked_change", "pre_effect", getArgusCurrentInputEventId(),
                    getArgusCurrentInputSource(),
                    "oldChecked=" + mChecked + ";newChecked=" + checked
                            + ";broadcasting=" + mBroadcasting);
