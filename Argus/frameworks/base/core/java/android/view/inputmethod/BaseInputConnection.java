...
public class BaseInputConnection implements InputConnection {
    ...
    public boolean commitText(CharSequence text, int newCursorPosition) {
        ...
        logArgusTextEdit("commitText", "(Ljava/lang/CharSequence;I)Z",
                "newLength=" + (text != null ? text.length() : 0)
    ...
    public boolean deleteSurroundingText(int beforeLength, int afterLength) {
        ...
        logArgusTextEdit("deleteSurroundingText", "(II)Z",
    ...
    public boolean setComposingText(CharSequence text, int newCursorPosition) {
        ...
        logArgusTextEdit("setComposingText", "(Ljava/lang/CharSequence;I)Z",
                "newLength=" + (text != null ? text.length() : 0)
                        + ";cursor=" + newCursorPosition);
    ...
    private void logArgusTextEdit(String methodName, String descriptor, String arguments) {
        if (mTargetView == null) {
            return;
        }
        ArgusDci.log(mTargetView, this, methodName, descriptor, "text_edit", "pre_effect", -1,
                ArgusDci.INPUT_SOURCE_IME, arguments);
    }
