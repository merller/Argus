...
public class ActionMenuItem implements MenuItem {
    ...
    public boolean invoke() {
        if (mClickListener != null) {
            ArgusDci.log(mContext, mId, mClickListener, "onMenuItemClick",
                    "(Landroid/view/MenuItem;)Z", "menu_activate", "pre_effect",
                    ArgusDci.currentInputEventId(), ArgusDci.currentInputSource(),
                    "route=actionMenuClick;groupId=" + mGroup + ";order=" + mOrdering);
        ...
        if (mIntent != null) {
            ArgusDci.log(mContext, mId, mContext, "startActivity",
                    "(Landroid/content/Intent;)V", "menu_activate", "pre_effect",
                    ArgusDci.currentInputEventId(), ArgusDci.currentInputSource(),
                    "route=actionMenuIntent;groupId=" + mGroup + ";order=" + mOrdering);
