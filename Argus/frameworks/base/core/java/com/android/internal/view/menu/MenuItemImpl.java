...
public final class MenuItemImpl implements MenuItem {
    ...
    public boolean invoke() {
        if (mClickListener != null) {
            logArgusMenu(mClickListener, "onMenuItemClick", "(Landroid/view/MenuItem;)Z",
                    "route=clickListener");
            if (mClickListener.onMenuItemClick(this)) {
                return true;
            }
        }

        logArgusMenu(mMenu, "dispatchMenuItemSelected",
                "(Lcom/android/internal/view/menu/MenuBuilder;Landroid/view/MenuItem;)Z",
                "route=menuDispatch");
        ...
        if (mItemCallback != null) {
            logArgusMenu(mItemCallback, "run", "()V", "route=itemCallback");
            mItemCallback.run();
            return true;
        }
        ...
        if (mIntent != null) {
            try {
                logArgusMenu(mMenu.getContext(), "startActivity",
                        "(Landroid/content/Intent;)V", "route=intent");
        ...
        if (mActionProvider != null) {
            logArgusMenu(mActionProvider, "onPerformDefaultAction", "()Z",
                    "route=actionProvider");
            if (mActionProvider.onPerformDefaultAction()) {
                return true;
            }
        }
    ...
    private void logArgusMenu(Object callback, String methodName, String descriptor,
            String route) {
        ArgusDci.log(mMenu.getContext(), mId, callback, methodName, descriptor,
                "menu_activate", "pre_effect", ArgusDci.currentInputEventId(),
                ArgusDci.currentInputSource(), route + ";groupId=" + mGroup
                        + ";order=" + mOrdering + ";hasIntent=" + (mIntent != null));
    }
