...
status_t InputPublisher::publishKeyEvent(uint32_t seq, int32_t eventId, int32_t deviceId,
    ...
    msg.body.key.policyFlags = policyFlags;
...
status_t InputPublisher::publishMotionEvent(
        ...
        std::array<uint8_t, 32> hmac, uint32_t policyFlags, int32_t action, int32_t actionButton, int32_t flags,
    ...
    msg.body.motion.policyFlags = policyFlags;
...
void InputConsumer::initializeKeyEvent(KeyEvent* event, const InputMessage* msg) {
    event->initialize(msg->body.key.eventId, msg->body.key.deviceId, msg->body.key.source,
                      msg->body.key.displayId, msg->body.key.hmac, msg->body.key.policyFlags, msg->body.key.action,
...
void InputConsumer::initializeMotionEvent(MotionEvent* event, const InputMessage* msg) {
    ...
    event->initialize(msg->body.motion.eventId, msg->body.motion.deviceId, msg->body.motion.source,
                      msg->body.motion.displayId, msg->body.motion.hmac, msg->body.motion.policyFlags, msg->body.motion.action,
