...
public:
    ...
    inline uint32_t getPolicyFlags() const { return mPolicyFlags; }

    inline void setPolicyFlags(uint32_t policyFlags) { mPolicyFlags = policyFlags; }
...
public:
    ...
    void initialize(int32_t id, int32_t deviceId, uint32_t source, int32_t displayId,
                    std::array<uint8_t, 32> hmac, uint32_t policyFlags, int32_t action, int32_t flags, int32_t keyCode,
